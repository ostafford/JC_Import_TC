...
import { asExportEmployeeName, type ExportEmployeeName } from "@sch-import/shared";
...
export async function parseScheduleExport(content: Buffer): Promise<ScheduleExportRow[]> {
  const workbook = new ExcelJS.Workbook();
  // exceljs's bundled types predate current @types/node's generic Buffer — harmless mismatch.
